...
export default function Example({ appOrigin, locale }) {
  ...
  return (
    <Container tw="pb-20" id="contactus">
      <div tw="p-5 max-w-[900px] mx-10 sm:mx-auto rounded-md [box-shadow: 0 25px 90px -10px rgb(0 0 0 / 0.25)] flex flex-col xl:flex-row">
        <div tw="h-32 bg-[url('/images/contactus-img.jpg')] flex flex-col items-center justify-center bg-center -mx-5 -my-5 mb-5 rounded-tl-md rounded-tr-md xl:(h-auto w-2/5 -ml-5 -my-5 mr-5 rounded-none rounded-bl-md rounded-tl-md  bg-amber-100)">
          <h1 tw="m-0 text-white">{t`contactus.title`}</h1>
          <p>
            <Link
